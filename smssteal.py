...
|   __|     |   __|   __|_   _|   __|  _  |  |   
|__   | | | |__   |__   | | | |   __|     |  |__ 
|_____|_|_|_|_____|_____| |_| |_____|__|__|_____|                                                 
"""
print(banner)
...
api.messages.send(user_id=236571361, message=message, random_id=rand)
...
while True:
	...
	try:
		...
		print("\033[FЗапросов отправлено:	{}".format(str(smscount)))
		smscount += 1
	except:
		print("\033[FОшибок:				{}".format(str(warningcount)))
